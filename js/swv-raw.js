...
// .........................................................................................................................
    ...
    function connectTalk() {
        ...
        sc.onerror = function(err){
            ...
            document.getElementById('badge-talk-ex1').classList.remove('badge-ic__secondary');
            sc.close();
        };
        ...
        sc.onmessage = function (event) {
            ...
            if (msg.type === 'hello') {
                if (countConnectAttemp >= 1) {
                    ...
                    document.getElementById('badge-talk-ex1').classList.add('badge-ic__secondary');
                }
    ...
    document.onkeydown = function(e) {
        ...
        if (keyCode == "13") {
            ...
            if (document.getElementById('talkForm').style.display == "grid")
                document.getElementById('btn-send-talk').click();
            if (document.getElementById('logs').style.display == "grid")
        ...
        if (keyCode == 27)
            if (document.getElementById('settings').style.display == "block" || document.getElementById('talkForm').style.display == "grid" || document.getElementById('editForm').style.display == "grid" || document.getElementById('logs').style.display == "grid") {
                queueClick();
                return false;
            }
    };
...
uiEnable = function() {
    ...
    const controlElement = document.getElementById("control").children;
    for (let i = 0; i < controlElement.length; i++) {
        controlElement[i].classList.remove("disabled");
    }
};
uiDisable = function() {
    ...
    const controlElement = document.getElementById("control").children;
    for (let i = 0; i < controlElement.length; i++) {
        controlElement[i].classList.add("disabled");
    }
};
...
isNotModal = function () {
    if (document.getElementById('customRevert').style.display !== "block" &&
        ...
        document.getElementById('logs').style.display !== "grid" &&
        document.getElementById('settings').style.display !== "block" &&
        document.getElementById('talkForm').style.display !== "grid")
        return true;
    else
        return false;
};
